...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWF0cml4MTc4NCIsImEiOiJja3ZocXZhN3cxb3IzMndvMHk2Y3RwNTM5In0.ZpH40YjIqSTIm7wVZdBHXQ';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51JmdGMSBG4P2WYdgAb5uTy5DWPWaVzT88duHOYkKq0G99fK0rNZcB6pFGwQdJUoFniZ6GXeCLHg97Zi7FmOjdieQ00PknbLiKU'); // 1) Get checkout session from API

            _context.next = 4;
            return (0, _axios.default)("http://localhost:5000/api/v1/booking/checkout-session/".concat(tourId));
